...
.dc-dialog-container button,
.dc-dialog-container input,
.dc-dialog-container select,
.dc-dialog-container select option,
.dc-dialog-container textarea {
    line-height: normal;
...
.dc-dialog-container input:focus,
.dc-dialog-container select:focus,
.dc-dialog-container textarea:focus {
    border-color: #1890ff;
    outline: none;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}

.dc-dialog-container button[disabled],
.dc-dialog-container input[disabled],
.dc-dialog-container select[disabled],
.dc-dialog-container textarea[disabled] {
...
.dc-dialog-container select option:hover {
    background-color: #f0f0f0;
}

.dc-dialog-container select option:checked {
    background-color: #b3d9ff; /* 设置选中时的背景颜色 */
}
...
#dc_dialogContainer textarea:focus {
    border-color: #1890ff;
    outline: none;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}
...
/* 自定义滚动条样式 */
#dc_dialogContainer #dcPanelBody::-webkit-scrollbar {
    width: 8px;
}

#dc_dialogContainer #dcPanelBody::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 4px;
}

#dc_dialogContainer #dcPanelBody::-webkit-scrollbar-thumb {
    background: #c1c1c1;
    border-radius: 4px;
}

#dc_dialogContainer #dcPanelBody::-webkit-scrollbar-thumb:hover {
    background: #a8a8a8;
}
...
#dc_dialogContainer #dcPanelBody .dcTitle-text {
    font-weight: 500;
    color: #333333;
    margin-bottom: 4px;
    display: inline-block;
...
#dc_dialogContainer .dcNumberbox:focus-within {
    border-color: #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}
...
/* 主要按钮样式（确认按钮） */
#dc_dialogContainer .dclinkbutton.dc-primary-button {
    background: #1890ff;
    border: 1px solid #1890ff;
    color: #ffffff;
}

#dc_dialogContainer .dclinkbutton.dc-primary-button:hover {
    background: #40a9ff;
...
#dcPanelBody .dc_checkboxs label input[type="checkbox"] {
    margin-right: 8px;
    width: 16px;
    height: 16px;
    accent-color: #1890ff;
...
.DocumentSettings #advancedTab,
.DocumentSettings #basicTab{
   height: calc(100% - 50px);
}

#TerminalTextGroup,#TerminalTextInMiddlePageGroup{
    display: none;
}

.DocumentSettings .dc_tab-nav {
    display: flex;
    border-bottom: 1px solid #f0f0f0;
    background-color: #fafafa;
}

.DocumentSettings .dc_tab-item {
    padding: 10px 20px;
    cursor: pointer;
...
.DocumentSettings .dc_tab-item.active {
    color: #1890ff;
    border-bottom-color: #1890ff;
    background-color: white;
}

.DocumentSettings .dc_tab-item:hover {
    color: #1890ff;
}

/* Tab内容 */
.DocumentSettings .dc_tab-content {
    display: none;
}

.DocumentSettings .dc_tab-content.active {
    display: block;
}

/* 弹窗内容 */
.DocumentSettings .dc_modal-content {
    padding: 20px;
    display: flex;
    gap: 20px;
    height: 100%;
...
/* 左侧设置面板 */
.DocumentSettings .dc_settings-panel {
    flex: 1;
    display: flex;
...
.DocumentSettings .dc_setting-group {
    display: flex;
    flex-direction: column;
    gap: 6px;
}

.DocumentSettings .dc_setting-label {
    font-size: 14px;
    font-weight: 500;
    color: #333;
    margin-bottom: 3px;
...
/* 单选按钮组 */
.DocumentSettings .dc_radio-group {
    display: flex;
    gap: 16px;
}

.DocumentSettings .dc_radio-item {
    display: flex;
    align-items: center;
    gap: 6px;
    cursor: pointer;
...
.DocumentSettings .dc_radio-input {
    width: 16px;
    height: 16px;
    accent-color: #1890ff;
}

.DocumentSettings .dc_radio-label {
    font-size: 12px;
    color: #333;
}

/* 下拉选择 */
.DocumentSettings .dc_select {
    padding: 6px 10px;
    border: 1px solid #d9d9d9;
    border-radius: 4px;
    font-size: 12px;
...
.DocumentSettings .dc_select:focus {
    outline: none;
    border-color: #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}
...
/* 输入框组 */
.DocumentSettings .dc_input-group {
    display: flex;
    gap: 8px;
    align-items: center;
}

.DocumentSettings .dc_input-group label {
    font-size: 12px;
    color: #666;
    min-width: 35px;
}

.DocumentSettings .dc_input {
    padding: 5px 6px;
    border: 1px solid #d9d9d9;
    border-radius: 4px;
    font-size: 12px;
...
.DocumentSettings .dc_input:focus {
    outline: none;
    border-color: #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}

.DocumentSettings .dc_input:disabled {
    background-color: #f5f5f5;
    color: #999;
    cursor: not-allowed;
}
...
/* 复选框 */
.DocumentSettings .dc_checkbox-item {
    display: flex;
    align-items: center;
    gap: 6px;
    cursor: pointer;
}
.DocumentSettings .dc_checkbox-item span{
    font-size: 12px;
    color: #666;
}
.DocumentSettings .dc_checkbox-input {
    width: 16px;
    height: 16px;
    accent-color: #1890ff;
}

.DocumentSettings .dc_checkbox-label {
    font-size: 12px;
    color: #333;
}

/* 右侧预览面板 */
.DocumentSettings .dc_preview-panel {
    flex: 1;
    display: flex;
...
.DocumentSettings .dc_page-preview {
    position: relative;
    background-color: white;
    border: 1px solid #d9d9d9;
...
.DocumentSettings .dc_page-preview.portrait {
    width: 180px;
    height: 255px;
}

.DocumentSettings .dc_page-preview.landscape {
    width: 255px;
    height: 180px;
}

.DocumentSettings .dc_printable-area {
    position: absolute;
    border: 2px dashed #ff4d4f;
    background-color: transparent;
}

.DocumentSettings .dc_printable-area.portrait {
    top: 15px;
    left: 15px;
    right: 15px;
    bottom: 15px;
...
.DocumentSettings .dc_printable-area.landscape {
    top: 12px;
    left: 12px;
    right: 12px;
    bottom: 12px;
...
/* 页眉页脚预览 */
.DocumentSettings .dc_header-preview {
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
...
.DocumentSettings .dc_footer-preview {
    position: absolute;
    bottom: 0;
    left: 0;
    right: 0;
...
/* 装订线预览 */
.DocumentSettings .dc_binding-line {
    position: absolute;
    top: 0;
    bottom: 0;
    width: 12px;
...
.DocumentSettings .dc_binding-line.left {
    left: 0;
}

.DocumentSettings .dc_binding-line.right {
    right: 0;
}

/* 边距指示线 */
.DocumentSettings .dc_margin-line {
    position: absolute;
    background-color: #ff4d4f;
    border: 1px dashed #ff4d4f;
}

.DocumentSettings .dc_margin-line.top {
    top: 0;
    left: 50%;
...
.DocumentSettings .dc_margin-line.bottom {
    bottom: 0;
    left: 50%;
    transform: translateX(-50%);
    width: 30px;
...
.DocumentSettings .dc_margin-line.left {
    left: 0;
    top: 50%;
...
.DocumentSettings .dc_margin-line.right {
    right: 0;
    top: 50%;
    transform: translateY(-50%);
    width: 3px;
...
.DocumentSettings .dc_setting-group-Terminal .dc_checkbox-item span{
    width:108px;
}
.DocumentSettings .dc_setting-group-Terminal .dc_checkbox-item select,
.DocumentSettings .dc_setting-group-Terminal .dc_checkbox-item input{
    width: 160px;
    font-size: 12px;
    padding: 5px 10px;
}

.DocumentSettings #TerminalTextFontName {
    width: 90px;
}

.DocumentSettings #TerminalTextFontSize {
    width: 66px;
}
...
#dc_dialogContainer #dc_FourValues_table_td2_value1_type_Time,
#dc_dialogContainer #dc_FourValues_table_td2_value4_type_Time{
    display: none;
}
#dc_dialogContainer  .dc_FourValues_table_td2_value_type_checkbox {
    display: flex;
    align-items: center;
    justify-content: center;
}

#dc_dialogContainer #dcPanelBody.dc_FourValuesElement  #dc_FourValues_table_td2_value1_checkbox,
#dc_dialogContainer #dcPanelBody.dc_FourValuesElement  #dc_FourValues_table_td2_value4_checkbox {
    width: 16px;
}
...
/* 命令对话框 */
 ...
 .dc_DCExecuteCommandTable_container {
            ...
            .dc_navigation_buttons {
                display: flex;
                gap: 10px;
                margin-bottom: 4px !important;
            }

            .dc_navigation_buttons button.dc_nav_button {
                padding: 6px 20px;
                font-size: 12px;
            }
            ...
            #dc_DCExecuteCommandTable_search_input:focus {
                border-color: #2f9bff;
            ...
            #dc_DCExecuteCommandTable_search_btn:hover {
                background-color: #2f9bffc2;
            }

            .dc_available_commands_title {
                font-size: 13px;
                color: #333;
                padding: 0;
                margin: 0;
            ...
            #dc_DCExecuteCommandTable thead {
                display: block;
            ...
            #dc_DCExecuteCommandTable thead tr {
                display: table;
                width: 100%;
                table-layout: fixed;
            }

            #dc_DCExecuteCommandTable thead th {
                width: 50%;
                display: table-cell;
                font-weight: 600;
                color: #4c4c4c;
            ...
            #dc_DCExecuteCommandTable tbody {
                display: block;
                overflow-y: auto;
                flex: 1;
            }

            #dc_DCExecuteCommandTable tbody tr {
                display: table;
                width: 100%;
                table-layout: fixed;
            }

            #dc_DCExecuteCommandTable tbody td {
                width: 50%;
                display: table-cell;
            }
            ...
            #dcPanelBody.dc_DCExecuteCommandsElement tr:hover {
                background-color: #f8f9fa;
            }
            ...
            .dc_DCExecuteCommand_options_title {
                color: #333;
                font-size: 13px;
                margin: 0;
                padding: 0;
            ...
            #dc_dc_DCExecuteCommand_options:focus {
                border-color: #0078D7;
                box-shadow: 0 0 0 2px rgba(0, 120, 215, 0.25);
            }

            #dc_dc_DCExecuteCommand_options::placeholder {
                color: #999;
                font-style: italic;
            }
...
.dc_DisplayFormat_Style_box_center input {
    display: block;
    width: 154px;
}
...
.dc_input_TextColor_label #dc_TextColor_box:hover,
.dc_input_BackgroundTextColor_label #dc_BackgroundTextColor_box:hover,
.dc_BackgroundColorString_container #dc_BackgroundColorString_box:hover {
    border-color: #1890ff;
...
#dc_ListValueSeparatorChar_formbox_label{
    position: relative;
}

#dc_ListValueSeparatorChar_box {
    position: absolute;
    left: 140px;
    top: 68px;
    background: #f9f9f9;
...
.dc_listValueSeparatorChar_item {
...
.dc_listValueSeparatorChar_item:hover{
    background: #FFFFFF;
}
...
#dc_dialogContainer #dcPanelBody.AboutMessage {
    display: flex;
    gap: 24px;
    flex-direction: column;
    font-family: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif";
...
.dc-section-title-text{
    flex: 1;
    border-bottom: 1px solid #1890ff38;
    padding: 4px 0;
    color: #319cff;
    font-size: 13px;
    display: flex;
...
.dc-section-title-text #dcCopyInfo{
    cursor: pointer;
    color: #319cff;
    font-size: 12px;
}

#dc_dialogContainer .AboutMessage .dc-section-title {
    font-size: 12px;
    color: #333;
    margin-top: 6px;
    display: flex;
...
#dc_dialogContainer .AboutMessage .dc-section-title .dc-section-title-line {
    width: 4px;
    height: 26px;
    background: #1890ff;
    border-radius: 2px;
...
#dc_dialogContainer .AboutMessage  .dc-info-row {
    display: flex;
    margin-bottom: 8px;
    font-size: 12px;
    justify-content: space-between;
...
#dc_dialogContainer .AboutMessage  .dc-info-row:last-child {
    border-bottom: none;
}

.AboutMessage  .dc-info-label {
    width: 100px;
    color: #333;
    font-size: 12px;
    text-align: left;
}
.AboutMessage  .dc-info-value-color{
    color: #319cff;
}
.AboutMessage  .dc-info-value-color-red{
    color: #fe6b6d;
}
.AboutMessage  .dc-info-value-color-green{
    color: #66c936;
}
.AboutMessage  .dc-info-value {
   flex:1;
   text-align: right;
}
...
#dcPanelBody .dc_border_BorderTopColor_label > div:hover,
#dcPanelBody .dc_border_BorderBottomColor_label > div:hover,
#dcPanelBody .dc_border_BorderLeftColor_label > div:hover,
#dcPanelBody .dc_border_BorderRightColor_label > div:hover {
  border-color: #1890ff;
  transform: scale(1.05);
}
...
/*段落*/
#dcPanelBody.dc_paragraph {
    width: 100%;
    height: 100%;
    display: flex;
    flex-direction: column;
}
#dcPanelBody.dc_paragraph .dc_paragraph_item {
    display: flex;
    align-items: center;
...
#dcPanelBody.dc_paragraph .dc_paragraph_item_label {
    width: 86px;
}
#dcPanelBody.dc_paragraph  .dc_Box .dc_paragraph_item_label{
    width: 76px;
}
#dcPanelBody.dc_paragraph .dc_paragraph_item input[type="checkbox"]{
    margin-right: 6px;
}
#dcPanelBody.dc_paragraph .dc_paragraph_item input[type="number"],
#dcPanelBody.dc_paragraph .dc_paragraph_item select {
    width: 156px;
}
...
#dcPanelBody.dc_tableDialog .dc_visible_expression:hover {
    background: #e6e6e6;
    border-color: #b0b0b0;
    color: #333333;
}
...
#dcPanelBody.dc_tableDialog #dc_TableBackgroundText_box:hover {
    border-color: #1890ff;
    transform: scale(1.05);
}
...
/* 选择医学表达式的对话框 */
#dcPanelBody .dc_MedicalExpressionChooseDiv.dc_MedicalExpressionChooseDiv_active{
  /*  background-color: #d7e4f2; */
    background: #0078D7;
    color: #FFFFFF;
}
...
#dcPanelBody .dc_DirectoryField_Content .dc_DirectoryField_Content_DisplayLevel{
    margin:15px 0; 
}
#dcPanelBody .dc_DirectoryField_Content label.dc_flex span.dcTitle-text {
    width: 72px;
}
#dcPanelBody .dc_DirectoryField_Content .dc_DirectoryField_ShowPageIndex{
    margin-left: 6px;
}
`;
//线的样式列表
...
let MOCKARRAY = [
    ...
    { name: 'InsertDirectoryField', description: "插入目录" },
...
var MEDICALCHARACTERSIMGOBJECT = [
    ...
    },
    {
        ...
        "title": "视野图值",
        "base64ImgSrc": "data:image/png;base64,"
    },
    {
        "expressionStyle": "FourValues5",
        "title": "婚育史",
        "base64ImgSrc": "data:image/png;base64,"
    },
    {
        "expressionStyle": "ElectricPulpTestingTeeth",
        "title": "电活力测试牙位图",
        "base64ImgSrc": "data:image/png;base64,"
    }
    ,
    {
        "expressionStyle": "StationaryBridgeTeeth",
        "title": "固定桥牙位图",
        "base64ImgSrc": "data:image/png;base64,"
    },
    {
        "expressionStyle": "PDTeech",
        "title": "探诊深度设置",
        "base64ImgSrc": "data:image/png;base64,"
    },
    {
        "expressionStyle": "FourValues4",
        "title": "出血指数",
        "base64ImgSrc": "data:image/png;base64,"
    },
    {
        "expressionStyle": "AdvancedTeech",
        "title": "混合牙位图",
        "base64ImgSrc": "data:image/png;base64,"
    }
];
...
var IMGEDITSVGOBJECT = {
    ...
    GLY: `data:image/png;base64,`,
    GY: `data:image/png;base64,`,
    SLY: `data:image/png;base64,`,
    SY: `data:image/png;base64,`,
    ZY: `data:image/png;base64,`,
};
//输入域的属性表达式的属性列表
